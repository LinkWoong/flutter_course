...
class _ProductManagerState extends State<ProductManager> {
  List<String> _products = []; // Create new card when pressing the button
    ...
    return Column(children: [
      Container(
        ...
        child: ProductControl(
            _updateProducts), // passing a function reference to another class for initialization.
      ),
      Expanded(
          child: Products(
              _products)), // expand the full screen, will hit performance issue
    ]);
  }
}
