  ...
  Widget build(BuildContext context) {
    ...
    return Column(children: [
      Container(
        ...
        child: ProductControl(addProduct), // passing a function reference to another class for initialization.
      ),
      Expanded(
          child: Products(
              _products, deleteProduct: deleteProduct)), // expand the full screen, will hit performance issue
    ]);
  }
}
